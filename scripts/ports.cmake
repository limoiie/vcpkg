...
if(CMD MATCHES "^BUILD$")
    ...
    if(DEFINED VCPKG_LINKER_SUBSYSTEM)
        if(DEFINED VCPKG_LINKER_SUBSYSTEM_MINIMUM_VERSION)
            set(VCPKG_LINKER_FLAGS "${VCPKG_LINKER_FLAGS} /SUBSYSTEM:${VCPKG_LINKER_SUBSYSTEM},${VCPKG_LINKER_SUBSYSTEM_MINIMUM_VERSION}")
        else()
            set(VCPKG_LINKER_FLAGS "${VCPKG_LINKER_FLAGS} /SUBSYSTEM:${VCPKG_LINKER_SUBSYSTEM}")
        endif()
    elseif(DEFINED VCPKG_LINKER_SUBSYSTEM_MINIMUM_VERSION)
        message(FATAL_ERROR "VCPKG_LINKER_SUBSYSTEM_MINIMUM_VERSION requires also setting VCPKG_LINKER_SUBSYSTEM")
    endif()
